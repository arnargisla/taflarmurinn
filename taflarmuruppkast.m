...
L(2) = Link('alpha', pi/2, 'a',    0, 'd', 0.2);
L(3) = Link('alpha',    0, 'a', 0.30, 'd',   0);
L(4) = Link('alpha',    0, 'a', 0.30, 'd',   0);
L(5) = Link('alpha', pi/2, 'a', 0.30, 'd',   0);
L(6) = Link('alpha', pi/2, 'a', 0.30, 'd',   0);
